            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="#"><img src="{{asset('img/1-1.png')}}" alt="" height="30px"> &nbsp;Rank Đồng</a>
                        <a class="dropdown-item" href="#"><img src="{{asset('img/2-1.png')}}" alt="" height="30px"> &nbsp;Rank Bạc</a>
                        <a class="dropdown-item" href="#"><img src="{{asset('img/3-1.png')}}" alt="" height="30px"> &nbsp;Rank Vàng</a>
                        <a class="dropdown-item" href="#"><img src="{{asset('img/4-1.png')}}" alt="" height="30px"> &nbsp;Bạch Kim</a>
                        <a class="dropdown-item" href="#"><img src="{{asset('img/5-1.png')}}" alt="" height="30px"> &nbsp;Kim Cương</a>
                        <a class="dropdown-item" href="#"><img src="{{asset('img/6-1.png')}}" alt="" height="30px"> &nbsp;Cao Thủ</a>
                        <a class="dropdown-item" href="#"><img src="{{asset('img/7-1.png')}}" alt="" height="30px"> &nbsp;Thách Đấu</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
